# Generated by Django 4.2 on 2024-05-15 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tg_service.children')),
                ('parent_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tg_service.parents')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='children',
            name='parent_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tg_service.parents'),
        ),
        migrations.AddField(
            model_name='children',
            name='user',
